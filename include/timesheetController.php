...
if(isset($_REQUEST['_search']) && $searchOn!='false' && $type=='expenseTimesheet')
{
	...
	$account=new Account();
	$response=$account->getCurrentUserDetails($toDate,$fromDate,$page,$limit,$sidx,$sord,$wh);
	echo json_encode($response);
	unset($response);
}
else if($type=='expenseTimesheetOperation')
{
...
else if($type=='expenseTimesheet')
{
	...
	$response=$account->getCurrentUserDetails($toDate,$fromDate,$page,$limit,$sidx,$sord);
	echo json_encode($response);
	unset($response);
}
?>